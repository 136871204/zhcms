        ...
        <form method="post" class="zh-form" name="product_fm" id="product_fm"   onsubmit="return false;"   action="{|U:add}" enctype="multipart/form-data" >
            <div class="tab">
                <ul class="tab_menu">
                    ...
                    <li lab="tab_shotcontent"><a href="#">推荐理由</a></li>
                    <?php
                    ...
                    ?>
                    <li lab="tab_attachment" ><a href="#">线路附件</a></li>
                    ...
                    <div id="tab_basic">
                        <table class="table1">
                            ...
                            <tr>
                                <th>产品编号：</th>
                                <td>
                                    <input type="text" name="linesn" value="{$info['linesn']}"  class="set-text-xh text_500 mt-2"/>
                                </td>
                            </tr>
                            <tr>
                                <th>燃油费：</th>
                            ...
                            <tr>
                                <th>咨询电话：</th>
                                <td>
                                    <input type="text" name="hotlinetel" value="{$info['hotlinetel']}"  class="set-text-xh text_400 mt-2"/>
                                </td>
                            </tr>
                            <tr>
                                <th>成团人数:</th>
                                <td>
                                    <input type="text" name="corporationnum" value="{$info['corporationnum']}"  class="set-text-xh text_100 mt-2"/>
                                </td>
                            </tr>
                            <tr>
                                <th>节假日：</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span >满意度</span>
                                    <input type="text" name="satisfyscore" value="{$info['satisfyscore']}" data-regrex="number" data-msg="*必须为数字" class="w60"/>
                                    <span >销量</span>
                    ...
                    <?php
                      ...
                      { 
                        if($col['columnname']=='jieshao'){
                                ...
                                <?php
                                   ...
                                   foreach($info['linejieshao_arr'] as $k=>$v)
                                   {
                                       ...
                                       $imageup.='<fieldset class="img_list">';
                                            ...
                                            $imageup.='</div>';
                                        $imageup.='</fieldset>';
                                        $imageup.='<button class="zh-cancel-small" onclick=\'file_upload({"id":"img_timg'.$v['day'].'","type":"images","num":"10","name":"timg'.$v['day'].'","filetype":"jpg,png,gif,jpeg","upload_img_max_width":"800","upload_img_max_height":"800","thumb_type":"5","dir":"line","thumb_size":"300*300"})\' type="button">图片上传</button> <span class="timg'.$v['day'].' validate-message"></span>     ';
                            ...
                            echo '<textarea id="'.$col['columnname'].'" name="'.$col['columnname'].'">';
                        ...
                        <table class="table1">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="zh-cancel-small" onclick='file_upload({"id":"linepic","type":"image","dir":"config","num":1,"name":"linepic","filetype":"jpg,png,gif,jpeg","upload_img_max_width":"800","upload_img_max_height":"800","thumb_type":"5","dir":"line","thumb_size":"500*500,300*300,200*200"})' type="button">图片上传</button>
                                    &nbsp;&nbsp;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="zh-cancel-small" onclick='file_upload({"id":"img_piclist","type":"images","num":"10","name":"piclist","filetype":"jpg,png,gif,jpeg","upload_img_max_width":"800","upload_img_max_height":"800","thumb_type":"5","dir":"line","thumb_size":"500*500,300*300,200*200"})' type="button">图片上传</button> <span class="piclist validate-message"></span>                   
                                </td>
                            </tr>
                            <tr>
                                <th class="w80">行程附件</th>
                                <td>
                                    <fieldset class="img_list">
                        ...
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="zh-cancel-small" type="button"  onclick="select_exterior('line','id','linename','线路名称','','multiple','hotlines');">外部データ選択</button>                    
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        function beforeJieshao(){
            ...
            if(days<=0 || isNaN(days) )
            {
                ...
                imageup+='<fieldset class="img_list">';
                    ...
                    imageup+='</div>';
                imageup+='</fieldset>';
                imageup+='<button class="zh-cancel-small" onclick=\'file_upload({"id":"img_timg{day}","type":"images","num":"10","name":"timg{day}","filetype":"jpg,png,gif,jpeg","upload_img_max_width":"800","upload_img_max_height":"800","thumb_type":"5","dir":"line","thumb_size":"300*300"})\' type="button">图片上传</button> <span class="timg{day} validate-message"></span>     ';
