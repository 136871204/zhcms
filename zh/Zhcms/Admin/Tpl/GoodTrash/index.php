		...
		<div class="wrap">
			...
			<table class="table2 zh-form">
				...
				<tr>
                    ...
                    <a href="{|U:'Ec/Goods/index',array('id'=>$goods['goods_id'])}" target="_blank" title="预览"><img src="__STATIC__/image/icon_view.gif" width="16" height="16" border="0" /></a>
                    ...
                    <a href="{|U:'Admin/Goods/operator',array('act'=>'copy','goods_id'=>$goods['goods_id'])}" title="复制"><img src="__STATIC__/image/icon_copy.gif" width="16" height="16" border="0" /></a>
                    <a href="javascript:;" onclick="javascript:confirm('您确实要把该商品放入回收站吗？')?zh_ajax('{|U:remove}',{id:{$goods.goods_id}}):void(0);" title="回收站"><img src="__STATIC__/image/icon_trash.gif" width="16" height="16" border="0" /></a>
                    </td>
                </tr>
                </list>
			</table>
