    ...
    <div class="wrap">
        <div class="menu_list">
            <ul>
                ...
                <li><a href="javascript:hd_ajax('{|U:update_cache}');">キャッシュ更新</a></li>
            </ul>
        </div>
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input type="radio" name="state" value="1" <if value="$field.state==1">checked="checked"</if>/> 表示 
                    </label>
                    <label>
                        <input type="radio" name="state" value="0" <if value="$field.state==0">checked="checked"</if>/> 隠す 
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="type">
                        <option value="1" <if value="$field.status==1">checked="checked"</if>>メニュー+権限操作</option>
                        <option value="2" <if value="$field.status==2">checked="checked"</if>>普通メニュー</option>
                    </select>
                </td>
            </tr>
        </table>
