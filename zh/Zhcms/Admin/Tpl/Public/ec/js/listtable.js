...
{
    //listTable.edit(this, 'edit_product_sn', {$product.product_id})
...
{
    //listTable.toggle(this, 'toggle_show', {$brand.brand_id})
  ...
  if (res.error == 0)
  {
    obj.src = (res.content > 0) ? PUBLIC+'/ec/images/yes.gif' : PUBLIC+'/ec/images/no.gif';
  }
}
...
{
    //listTable.remove({$product.product_id}, '您确实要把该货品删除吗？', 'product_remove')
  if (opt == null)
  {
    opt = "remove";
  }
...
listTable.getPageSize = function()
{
  ...
  if (pageSize)
  {
    ...
    document.cookie = "ZHCMS[page_size]=" + ps + ";";
  }
}
