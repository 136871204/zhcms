...
class LineControl extends AuthControl {
    ...
    protected $magrecommend = array('美食','景点','文化');
    ...
    public function ajax_linesave(){
        ...
        $data_arr['linenight']=Q('lineday',0);
        ...
        foreach($title_arr as $k=>$v)
        {
           ...
           // p($k);
            ...
            if(isset($_POST['timg'.$k])){
                $images_arr=$_POST['timg'.$k]['path'];//Q('imgages');
                $imagestitle_arr=$_POST['timg'.$k]['alt'];
    ...
    public function line(){
        ...
        if($action=='read') {
           ...
           // p($sort);exit;
			...
			{
				$sql="select 
                        a.id,a.aid,a.linename,a.iconlist,a.lineprice,a.tprice,a.profit,a.startcity,
                        a.lineclassid as classid,a.attrid,a.lineclassid,a.webid,a.kindlist,a.ishidden,
                        a.piclist,a.themelist,a.supplierlist,
			...
			{
			    $sql="select 
                        a.id,a.aid,a.linename,a.supplierlist,a.iconlist,a.lineprice,a.tprice,a.profit,a.startcity,
            ...
            if(!empty($list)){
                foreach($list as $k=>$v){
                    ...
                    $suit=$lineSuitModel->where("lineid={$v['id']}")->order(' displayorder asc ')->All();
                    if(!empty($suit))
