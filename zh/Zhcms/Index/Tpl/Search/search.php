            ...
            <form action="__WEB__" class="zh-form">
				...
				<div class="search">
					...
					<select name="type" class="w100 h30">
						...
						<option value="tag" <if value="$zh.get.type eq 'tag'">selected=""</if> >Tag</option>
					</select>&nbsp;&nbsp;&nbsp;<br/><br/>
					キーワード：
					<input class="w300" type="text" value="{$zh.get.word}" placeholder="キーワードを入力..." required="" name="word">
