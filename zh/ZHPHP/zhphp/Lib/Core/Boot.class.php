...
final class Boot
{
     ...
     */
     static private function loadCoreFile(){
        $files = array(
            ...
            ZHPHP_FUNCTION_PATH . 'ECPassport.php',
            ZHPHP_FUNCTION_PATH . 'ECOrder.php',
            ZHPHP_FUNCTION_PATH . 'ECGoods.php',
            ZHPHP_FUNCTION_PATH . 'ECClips.php',
            ZHPHP_FUNCTION_PATH . 'ECArticle.php',
            ZHPHP_FUNCTION_PATH . 'ECTransaction.php',
            ZHPHP_FUNCTION_PATH . 'ECPayment.php',
    ...
    static private function compile()
    {
        ...
        $files = array(
            ...
            ZHPHP_FUNCTION_PATH . 'ECPassport.php', //公共函数
            ZHPHP_FUNCTION_PATH . 'ECOrder.php', //公共函数
            ZHPHP_FUNCTION_PATH . 'ECGoods.php', //公共函数
            ZHPHP_FUNCTION_PATH . 'ECClips.php', //公共函数
            ZHPHP_FUNCTION_PATH . 'ECArticle.php',
            ZHPHP_FUNCTION_PATH . 'ECTransaction.php',
            ZHPHP_FUNCTION_PATH . 'ECPayment.php',
