...
//echo 'aaa';
import('ZHPHP.Extend.Tool.integrates.integrate',null,'.php');
class Zhec extends integrate
{
    var $is_ecshop = 1;
    ...
    function check_user($username, $password = null)
    {
        ...
        if ($password === null)
        {
            ...
            return $this->db->getOne($sql,$this->field_id);
        }
        else
        {
