...
<div class="location">
	<div class="nums">
		...
		<a href="http://www.metacms.com/index.php?a=Member&c=Content&m=selectCategory&mid=<?php echo $zhcms['mid'];?>&cid=<?php echo $zhcms['cid'];?>" class="publish">
                <strong>+</strong>文章発表
            </a>
	</div>
	<h3>        <?php
            ...
            ?>
	                    <div class="article">
							...
							<div class="info">
								...
								<span>閲覧：<?php echo $field['click'];?> 返事：<?php echo $field['comment_num'];?></span>	
							</div>
	                    </div>
        ...
        <div class="right-list col-md-4">
            ...
            <article class="channel">
            	...
            	<div class="channel">
            		<ul>
            		        <?php
        $where = '';$type=strtolower(trim('son'));
        $cid=str_replace(' ','','');
        if(empty($cid)){
            $cid=Q('cid',NULL,'intval');
        }
