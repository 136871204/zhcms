...
<html>
<head>
    <title><?php echo $zhcms['catname'];?> - <?php echo C("webname");?></title>
...
<script src='http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/bootstrap/js/bootstrap.min.js'></script>
                ...
                <![endif]-->
    <link rel="stylesheet"  type='text/css' href="http://www.metacms.com/template/v5/css/article_list.css"/>
    <!--[if lt IE 8]>
...
<div class="location">
	<div class="nums">
		文章数：<?php echo $zhcms['content_num'];?> &nbsp;&nbsp;&nbsp;返事数：<?php echo $zhcms['comment_num'];?>
		 <a href="http://www.metacms.com/index.php?a=Member&c=Content&m=add&mid=<?php echo $zhcms['mid'];?>&cid=<?php echo $zhcms['cid'];?>" class="publish">
                <strong>+</strong>文章発表
            </a>
	</div>
	<h3>        <?php
        ...
        ?></h3>
	<p class="description">
		<?php echo $zhcms['cat_seo_description'];?>
	</p>
</div>
<!--内容主体-->
    ...
    <div class="row">
        ...
        if($result):
            ...
            ?>
	                    <div class="article">
	                    	<div class="icon">
	                    		<img src="<?php echo _default($field['icon'],'http://www.metacms.com/data/image/user/50.png');?>" alt="<?php echo $field['username'];?>" onmouseover="user.show(this,<?php echo $field['uid'];?>)"/>
	                    	</div>
	                    	<div class="title">
							...
							<div class="info">
								...
								<span>
									閲覧：<?php echo $field['click'];?> 返事：<?php echo $field['comment_num'];?>
