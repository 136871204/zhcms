    ...
    <div class="wrap">
        <div class="menu_list">
            <ul>
                ...
                <li><a href="javascript:hd_ajax('<?php echo U(update_cache);?>');">キャッシュ更新</a></li>
            </ul>
        </div>
...
echo "";
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input type="radio" name="state" value="1" <?php if($field['state']==1){?>checked="checked"<?php }?>/> 表示 
                    </label>
                    <label>
                        <input type="radio" name="state" value="0" <?php if($field['state']==0){?>checked="checked"<?php }?>/> 隠す 
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="type">
                        <option value="1" <?php if($field['status']==1){?>checked="checked"<?php }?>>メニュー+権限操作</option>
                        <option value="2" <?php if($field['status']==2){?>checked="checked"<?php }?>>普通メニュー</option>
                    </select>
                </td>
            </tr>
        </table>
