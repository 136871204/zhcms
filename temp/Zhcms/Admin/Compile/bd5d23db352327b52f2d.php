...
<div style="clear:both"></div>
    ...
    var field_name_empty = "会員登録項目名を入力してください。";
    //-->
    </script>
...
<?php }?>
            <table cellspacing='1' id="list-table">
                ...
                <?php if(is_array($reg_fields)):?><?php $index=0; ?><?php  foreach($reg_fields as $field){ ?>
                <tr>
                    <td class="first-cell" ><span onclick="listTable.edit(this,'edit_name', <?php echo $field['id'];?>)"><?php echo $field['reg_field_name'];?></span></td>
                    <td align="center"><span onclick="listTable.edit(this,'edit_order', <?php echo $field['id'];?>)"><?php echo $field['dis_order'];?></span></td>
                    <td align="center"><img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($field['display']){?>yes<?php  }else{ ?>no<?php }?>.gif" onclick="listTable.toggle(this, 'toggle_dis', <?php echo $field['id'];?>)" /></td>
                    <td align="center"><img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($field['is_need']){?>yes<?php  }else{ ?>no<?php }?>.gif" onclick="listTable.toggle(this, 'toggle_need', <?php echo $field['id'];?>)" /></td>
                    <td align="right">
                        <a href="<?php echo U('index');?>&act=edit&id=<?php echo $field['id'];?>">変更</a>
                        <?php if($field['type'] == 0){?>
                        | <a href="javascript:;" onclick="listTable.remove(<?php echo $field['id'];?>, '削除するか?')" title="削除">削除</a>
                        <?php }?>
                    </td>
                </tr>
