...
<script src='http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/bootstrap/js/bootstrap.min.js'></script>
                ...
                <![endif]-->
        <link rel="stylesheet"  type='text/css' href="http://www.metacms.com/template/v4/css/index.css"/>
		<!--[if lt IE 8]>
		<link rel="stylesheet"  type='text/css' href="http://www.metacms.com/template/v4/css/ie.css?ver=1.0 "/>
		<![endif]-->
        ...
        ?>
				...
				<div class="right-list col-md-4">
					...
					<article class="soft">
						...
						<div>
							<a href="www.metaphase.co.jp" class="zhcms" target="_blank">
								METACMS<span>バージョン: 2016-08-01</span>
							</a>
						</div>
						<div class="notice">
