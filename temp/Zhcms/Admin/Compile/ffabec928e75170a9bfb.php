...
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="javascript:;" class="action">Tag変更</a></li>
        </ul>
    </div>
    <div class="title-header">Tag変更</div>
    <form action="<?php echo U('edit');?>" method="post" onsubmit="return zh_submit(this,'<?php echo U(index);?>')" class="zh-form">
        <input type="hidden" name="tid" value="<?php echo $field['tid'];?>"/>
        <table class="table1">
            <tr>
                <th class="w100">tag</th>
                <td>
                    <input type="text" name="tag" value="<?php echo $field['tag'];?>" class="w200"/>
                </td>
            </tr>
            <tr>
                <th class="w100">統計</th>
