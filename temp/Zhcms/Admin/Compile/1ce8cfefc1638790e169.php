...
PHPSELF = '<?php echo $GLOBALS['user']['PHPSELF'];?>';
    ...
    <link rel="stylesheet" href="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Content/ztree/css/zTreeStyle/zTreeStyle.css" type="text/css">
    <script type="text/javascript" src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Content/ztree/js/jquery.ztree.all-3.5.min.js"></script>
    <base target="content"/>
    <style type="text/css">
    div#tree_title a{
    	color:#333;
...
div#move span.left{
    background: url("http://www.metacms.com/zh/Zhcms/Admin/Tpl/Content/img/ico_left.gif") no-repeat;
    left: -10px;
}
div#move span.right{
    background: url("http://www.metacms.com/zh/Zhcms/Admin/Tpl/Content/img/ico_right.gif") no-repeat;
    left: 5px;
}
/*右侧内容显示区*/
div#content {
...
#tree_title span {
    display: block;
    background: url("http://www.metacms.com/zh/Zhcms/Admin/Tpl/Content/ztree/css/zTreeStyle/img/diy/1_open.png");
    width: 15px;
    height: 15px;
    float: left;
    margin-right: 5px;
...
<div class="wrap">
    <div id="category_tree">
        <div id="tree_title">
            <span></span>
            <a href="javascript:;" onclick="get_category_tree();">カテゴリ更新</a>
        </div>
