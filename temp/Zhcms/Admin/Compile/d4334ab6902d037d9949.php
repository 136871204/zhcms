...
PHPSELF = '<?php echo $GLOBALS['user']['PHPSELF'];?>';
    ...
    <script type="text/javascript" src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Personal/js/edit_info.js"></script>
    <script>
...
<div class="wrap">
    ...
    <form action="<?php echo U('edit_info');?>" method="post" onsubmit="return zh_submit(this,'http://www.metacms.com/index.php?a=Admin&c=Personal&m=edit_info')" class="zh-form">
