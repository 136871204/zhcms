...
<?php }?>
            <table cellpadding="3" cellspacing="1">
                <tr>
                    <th><a href="javascript:listTable.sort('link_name'); ">リンク名</a><?php echo $sort_link_name;?></th>
                    <th><a href="javascript:listTable.sort('link_url'); ">リンク遷移先</a><?php echo $sort_link_url;?></th>
                    <th><a href="javascript:listTable.sort('link_logo'); ">リンクLOGO</a><?php echo $sort_link_logo;?></th>
                    <th><a href="javascript:listTable.sort('show_order'); ">表示ソート</a><?php echo $sort_show_order;?></th>
                    <th><?php echo L("admin_ecfriendlink_page_table_th5");?></th>
                </tr>
                <?php if(!empty($links_list)){?>
                    <?php if(is_array($links_list)):?><?php $index=0; ?><?php  foreach($links_list as $link){ ?>
                    <tr>
                        <td class="first-cell"><span onclick="listTable.edit(this, 'edit_link_name', <?php echo $link['link_id'];?>)"><?php echo $link['link_name'];?></span></td>
                        <td align="left"><span><a href="<?php echo $link['link_url'];?>" target="_blank"><?php echo $link['link_url'];?></a></span></td>
                        <td align="center"><span><?php echo $link['link_logo'];?></span></td>
                        <td align="right"><span onclick="listTable.edit(this, 'edit_show_order', <?php echo $link['link_id'];?>)"><?php echo $link['show_order'];?></span></td>
                        <td align="center">
                            <span>
                                <a href="<?php echo U('index');?>&act=edit&id=<?php echo $link['link_id'];?>" title="変更">
                                    <img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_edit.gif" border="0" height="16" width="16" />
                                </a>&nbsp;
                                <a href="javascript:;" onclick="listTable.remove(<?php echo $link['link_id'];?>, 'このデータを削除するか?')" title="削除">
