...
<div class="wrap">
    ...
    <form action="<?php echo U(edit);?>" method="post" class="zh-form" onsubmit="return zh_submit(this,'<?php echo U(index);?>');">
        <input type="hidden" name="rid" class="w300" value="<?php echo $field['rid'];?>"/>
        <table class="table1">
            <tr>
                <th class="w150">会員グループ名</th>
                <td>
                    <input type="text" name="rname" class="w300" value="<?php echo $field['rname'];?>" required=""/>
                </td>
            </tr>
            <tr>
                <th class="w100">積分&lt;</th>
                <td>
                    <input type="text" name="creditslower" class="w300" value="<?php echo $field['creditslower'];?>" required=""/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input type="radio" name="comment_state" value="1" <?php if($field['comment_state']==1){?>checked="checked"<?php }?>/> YES
                    </label> 
                    <label>
                        <input type="radio" name="comment_state" value="0" <?php if($field['comment_state']==0){?>checked="checked"<?php }?>/> NO
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        <input type="radio" name="allowsendmessage" value="1" <?php if($field['allowsendmessage']==1){?>checked="checked"<?php }?>/>YES
                    </label> 
                    <label>
                        <input type="radio" name="allowsendmessage" value="0" <?php if($field['allowsendmessage']==0){?>checked="checked"<?php }?>/>NO
                    </label>
                </td>
            </tr>
            <tr>
