...
PHPSELF = '<?php echo $GLOBALS['user']['PHPSELF'];?>';
    ...
    <script type="text/javascript" src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Navigation/js/js.js"></script>
    <link type="text/css" rel="stylesheet" href="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Navigation/css/css.css"/>
</head>
<body>
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="<?php echo U('add',array('pid'=>0));?>">ナビ新規</a></li>
    ...
    <table class="table2 zh-form form-inline">
        ...
        <?php $zh["list"]["n"]["total"]=0;if(isset($navigation) && !empty($navigation)):$_id_n=0;$_index_n=0;$lastn=min(1000,count($navigation));
...
if($_index_n>=$_total_n):$zh["list"]["n"]["last"]=true;endif;?>
            ...
            <tr>
                ...
                <td style="text-align: right">
                    ...
                    <?php  }else{ ?>
                        <a href="<?php echo U('add',array('pid'=>$n['nid']));?>">子ナビ新規</a> |
                    <?php }?>

                    <?php if($n['is_system']==0){?>
                        <a href="<?php echo U('edit',array('nid'=>$n['nid']));?>">修正</a> |
                        <a href="javascript:zh_ajax('<?php echo U(del);?>',{nid:<?php echo $n['nid'];?>})">削除</a>
                    <?php  }else{ ?>
