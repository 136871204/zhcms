...
<?php }?>
            ...
            <table cellpadding="3" cellspacing="1">
                <tr>
                    ...
                    <a href="javascript:listTable.sort('user_id'); ">番号</a><?php echo $sort_user_id;?>
                    </th>
                    <th><a href="javascript:listTable.sort('user_name'); ">会員名称</a><?php echo $sort_user_name;?></th>
                    <th><a href="javascript:listTable.sort('email'); ">メール</a><?php echo $sort_email;?></th>
                    <th><a href="javascript:listTable.sort('is_validated'); ">検証済む</a><?php echo $sort_is_validate;?></th>
                    <th>使える資金</th>
                    <th>凍結資金</th>
                    <th>ランクポイント</th>
                    <th>消費ポイント</th>
                    <th><a href="javascript:listTable.sort('reg_time'); ">登録日付</a><?php echo $sort_reg_time;?></th>
                    <th>操作</th>
                </tr>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <?php if($user['is_validated']){?> 
                                <img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/yes.gif"/> 
                            <?php  }else{ ?> 
                        ...
                        <td align="center">
                            <a href="<?php echo U('index');?>&act=edit&id=<?php echo $user['user_id'];?>" title="変更"><img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_edit.gif" border="0" height="16" width="16" /></a>
                            <a href="<?php echo U('index');?>&act=address_list&id=<?php echo $user['user_id'];?>" title="受け取り住所"><img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/book_open.gif" border="0" height="16" width="16" /></a>
                            <a href="<?php echo U('Admin/EcOrder/index');?>&act=list&user_id=<?php echo $user['user_id'];?>" title="注文見る"><img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_view.gif" border="0" height="16" width="16" /></a>
                            <a href="<?php echo U('Admin/EcAccountLog/index');?>&act=list&user_id=<?php echo $user['user_id'];?>" title="帳面明細"><img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_account.gif" border="0" height="16" width="16" /></a>
                            <a href="javascript:confirm_redirect('<?php if($user['user_money'] <> 0){?>該当会員が残高或いは借金があり\n<?php }?>この会員を削除するか？', '<?php echo U('index');?>&act=remove&id=<?php echo $user['user_id'];?>')" title="移除"><img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_drop.gif" border="0" height="16" width="16" /></a>
                        </td>
                    </tr>
