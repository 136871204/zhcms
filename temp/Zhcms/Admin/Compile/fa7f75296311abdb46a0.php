...
<div class="list-div">
    <table width="100%" cellpadding="3" cellspacing="1">
        ...
        <?php if(!empty($address)){?>
            <?php if(is_array($address)):?><?php $index=0; ?><?php  foreach($address as $val){ ?>
                <tr>
                    <td><?php echo htmlspecialchars($val['consignee']);?></td>
                    <td>
                        <?php echo $val['country_name'];?>&nbsp;&nbsp;<?php echo $val['province_name'];?>&nbsp;&nbsp;<?php echo $val['city_name'];?>&nbsp;&nbsp;<?php echo $val['district_name'];?><br />
                        <?php echo htmlspecialchars($val['address']);?>
                        <?php if($val['zipcode']){?>
                            [<?php echo htmlspecialchars($val['zipcode']);?>]
                        <?php }?>
                    </td>
                    <td>電話：<?php echo $val['tel'];?><br />携帯：<?php echo $val['mobile'];?><br/>email: <?php echo $val['email'];?></td>
                    <td>一番好み配達時間:<?php echo htmlspecialchars($val['best_time']);?><br/>マーク建築:<?php echo htmlspecialchars($val['sign_building']);?></td>
                </tr>
            <?php $index++; ?><?php }?><?php endif;?>
        <?php  }else{ ?>
            <tr><td class="no-records" colspan="4">データなし</td></tr>
        <?php }?>
