...
PHPSELF = '<?php echo $GLOBALS['user']['PHPSELF'];?>';
		...
		<script type="text/javascript" src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Index/js/menu.js"></script>
		<script type="text/javascript" src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Index/js/quick_menu.js"></script>
		<link type="text/css" rel="stylesheet" href="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Index/css/css.css"/>
		<link type="text/css" rel="stylesheet" href="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Index/css/quick_menu.css"/>
	</head>
    <body>
        <div class="nav">
            <!--头部左侧导航-->
...
echo "";
            ...
            <div class="r_menu">
                ...
                <span>|</span>
                <a href="http://www.metacms.com/index.php" target="_blank">
					トップページ
				</a>
                <span>|</span>
