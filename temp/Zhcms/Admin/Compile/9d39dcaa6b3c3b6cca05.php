...
<script type="text/javascript" src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/js/selectzone.js"></script>
<script type="text/javascript" src='http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/js/colorselector.js'></script>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="background-color:<?php echo $goods_name_color;?>;float:left;margin-left:2px;" id="font_color" onclick="ColorSelecter.Show(this);">
                            <img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/color_selecter.gif" style="margin-top:-1px;" />
                        </div>
                ...
                <tr>
                    <td class="label">
                        <a href="javascript:showNotice('noticeGoodsSN');" title="クリックして、提示情報を見る">
                            <img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/notice.gif" width="16" height="16" border="0" alt="クリックして、提示情報を見る"/>
                        </a> 
                        商品番号：
                    </td>
                    <td>
...
?>
                        ...
                        <table width="100%" id="tbody-volume" align="center">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php }?>
                                    優遇数<input type="text" name="volume_number[]" class="w100" value="<?php echo $volume_price['number'];?>"/>
                                    優遇価格<input type="text" name="volume_price[]" class="w100" value="<?php echo $volume_price['price'];?>"/>
                                </td>
                            </tr>
                            <?php $index++; ?><?php }?><?php endif;?>
                        </table>
                    ...
                    <td>
                        ...
                        <?php if($goods['goods_img']){?>
                            <a href="<?php echo U('index');?>&act=show_image&img_url=<?php echo $goods['goods_img'];?>" target="_blank">
                                <img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/yes.gif" border="0" />
                            </a>
                        <?php  }else{ ?>
                            <img src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/images/no.gif" />
                        <?php }?>
                        <br />
            ...
            <table width="90%" id="detail-table" style="display:none">
                <tr>
                    <td>
                    <script type="text/javascript" charset="utf-8" src="http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/Ueditor/ueditor.config.js"></script><script type="text/javascript" charset="utf-8" src="http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/Ueditor/ueditor.all.min.js"></script><script type="text/javascript">UEDITOR_HOME_URL="http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/Ueditor/"</script><script id="zh_goods_desc" name="goods_desc" type="text/plain"><?php echo $goods['goods_desc'];?></script>
        <script type='text/javascript'>
        $(function(){
                var ue = UE.getEditor('zh_goods_desc',{
                imageUrl:'http://www.metacms.com/index.php?a=Admin&c=EcGoods&act=add&m=ueditor_upload&g=Zhcms&water=0&uploadsize=2000000&maximagewidth=false&maximageheight=false'//处理上传脚本
                ,zIndex : 0
...
?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="is_best" value="1" <?php if($goods['is_best']){?>checked="checked"<?php }?> />&nbsp;ベスト&nbsp;&nbsp; 
                        <input type="checkbox" name="is_new" value="1" <?php if($goods['is_new']){?>checked="checked"<?php }?> />&nbsp;新品&nbsp;&nbsp;
                        <input type="checkbox" name="is_hot" value="1" <?php if($goods['is_hot']){?>checked="checked"<?php }?> />&nbsp;よく売れる&nbsp;&nbsp;
                    </td>
                </tr>
                <tr id="alone_sale_1">
                    <td class="label" id="alone_sale_2">公開：</td>
                    <td id="alone_sale_3">
                        <input type="checkbox" name="is_on_sale" value="1" <?php if($goods['is_on_sale']){?>checked="checked"<?php }?> /> チェックする場合と販売許可、チェックしない場合販売許可なし
                    </td>
                </tr>
                <tr>
                    <td class="label">普通商品として売る：</td>
                    <td>
                        <input type="checkbox" name="is_alone_sale" value="1" <?php if($goods['is_alone_sale']){?>checked="checked"<?php }?> /> チェックする場合普通商品として売る、チェックしない場合アクセサリー或いは贈り物として売るしかない。
                    </td>
                </tr>
                <tr>
                    <td class="label">運賃を免除する：</td>
                    <td>
                        <input type="checkbox" name="is_shipping" value="1" <?php if($goods['is_shipping']){?>checked="checked"<?php }?> /> チェックする場合運賃免除，チェックしない場合運賃必要。
                    </td>
                </tr>
                <tr>
                    <td class="label">商品キーワード：</td>
                    <td>
                        <input type="text" name="keywords" value="<?php echo htmlspecialchars($goods['keywords']);?>" size="40" /> スペースで仕切る 
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <?php if(is_array($img_list)):?><?php $index=0; ?><?php  foreach($img_list as $i=>$img){ ?>
                        <div id="gallery_<?php echo $img['img_id'];?>" style="float:left; text-align:center; border: 1px solid #DADADA; margin: 4px; padding:2px;">
                            <a href="javascript:;" onclick="if (confirm('この画像を削除するか？')) dropImg('<?php echo $img['img_id'];?>')">[-]</a><br />
                            <a href="<?php echo U('index');?>&act=show_image&img_url=<?php echo $img['img_url'];?>" target="_blank">
                                <img src="http://www.metacms.com/<?php if($img['thumb_url']){?><?php echo $img['thumb_url'];?><?php  }else{ ?><?php echo $img['img_url'];?><?php }?>" 
...
?>
            ...
            <div class="button-div">
                ...
                <?php }?>
                <input type="button" value="確定" class="button" onclick="validate('<?php echo $goods['goods_id'];?>')" />
...
<script type="text/javascript" src="http://www.metacms.com/zh/Zhcms/Admin/Tpl/Public/ec/js/tab.js"></script>
