...
PHPSELF = '<?php echo $GLOBALS['user']['PHPSELF'];?>';
    ...
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/common.js"></script>
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/jquery.hotkeys.js"></script>
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/msgbox/msgbox.js"></script>
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/extjs/ext-all.js"></script>
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/extjs/locale/ext-lang-zh_CN.js"></script>
    <link type="text/css" href="http://www.metacms.com/Static/tour/js/msgbox/msgbox.css" rel="stylesheet" />
    <link type="text/css" href="http://www.metacms.com/Static/tour/css/common.css" rel="stylesheet"/>
    <link type="text/css" href="http://www.metacms.com/Static/tour/js/extjs/resources/ext-theme-neptune/ext-theme-neptune-all-debug.css" rel="stylesheet"/>
   ...
   <script>
    ...
    <link type="text/css" href="http://www.metacms.com/Static/tour/css/style.css" rel="stylesheet"/>
    <link type="text/css" href="http://www.metacms.com/Static/tour/css/base.css" rel="stylesheet"/>
    <link type="text/css" href="http://www.metacms.com/Static/tour/css/base2.css" rel="stylesheet"/>
    <link type="text/css" href="http://www.metacms.com/Static/tour/css/plist.css" rel="stylesheet"/>   
    <link type="text/css" href="http://www.metacms.com/Static/tour/js/extjs/resources/ext-theme-neptune/ext-theme-neptune-all-debug.css" rel="stylesheet"/>   
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/uploadify/jquery.uploadify.min.js?t=2081955"></script>
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/listimageup.js"></script>
    <script type="text/javascript" src="http://www.metacms.com/Static/tour/js/common.js"></script>   
    <link type="text/css" href="http://www.metacms.com/Static/tour/js/uploadify/uploadify.css" rel="stylesheet"/>
...
<div class="wrap content-rt-td">
    <div  class="search-bar filter" id="search_bar" >
        <div class="pro-search ml-10" style=" float:left; margin-top:5px">
            ...
            <input type="button" value="検索" class="sty-btn1 default-btn wid_60" onclick="searchDest()" />
        </div>
        <span class="display-mdd">
            <a href="javascript:void(0);" onClick="togMod(this,0,'全体目的地')" <?php  if($typeid==0) echo 'class="on"';   ?>>全体</a>
            <a href="javascript:void(0);" onClick="togMod(this,1,'ツアー目的地')" <?php  if($typeid==1) echo 'class="on"';   ?>>ツアー</a>
            <a href="javascript:void(0);" onClick="togMod(this,2,'ホテル目的地')" <?php  if($typeid==2) echo 'class="on"';   ?>>ホテル</a>
            <a href="javascript:void(0);" onClick="togMod(this,3,'レンタカー目的地')" <?php  if($typeid==3) echo 'class="on"';   ?>>レンタカー</a>
            <a href="javascript:void(0);" onClick="togMod(this,4,'文章目的地')" <?php  if($typeid==4) echo 'class="on"';   ?>>文章</a>
            <a href="javascript:void(0);" onClick="togMod(this,5,'スポット目的地')" <?php  if($typeid==5) echo 'class="on"';   ?>>スポット</a>
            <a href="javascript:void(0);" onClick="togMod(this,6,'アルバム目的地')" <?php  if($typeid==6) echo 'class="on"';   ?>>アルバム</a>
            <a href="javascript:void(0);" onClick="togMod(this,13,'団体購入目的地')"<?php  if($typeid==13) echo 'class="on"';   ?>>団体購入</a>
            <a href="javascript:void(0);" onClick="togMod(this,11,'連れ旅目的地')"<?php  if($typeid==11) echo 'class="on"';   ?>>連れ旅</a>
            <?php if(is_array($addmodule)):?><?php $index=0; ?><?php  foreach($addmodule as $row){ ?>
                <a href="javascript:void(0);" onClick="togMod(this,<?php echo $row['id'];?>,'<?php echo $row['modulename'];?>目的地')" {if $typeid==$row['id']} class="on"{/if}><?php echo $row['modulename'];?></a>
    ...
    <div id="line_grid_panel" class="content-nrt">
        ...
        <div class="panel_bar">
            <a class="abtn" href="javascript:;" onClick="chooseAll()">全選</a>
            <a class="abtn" href="javascript:;" onClick="chooseDiff()">逆選</a>
            <a class="abtn" href="javascript:;" onClick="delDest()">削除</a>
        </div>
    </div>
</div>
<script>
SITEURL="http://www.metacms.com/index.php";
window.display_mode =<?php echo $typeid;?>;
var typename_json={type1:'ツアー',type2:'ホテル',type3:'レンタカー',type4:'攻略',type5:'スポット',type6:'アルバム',type13:'団体購入'}
    ...
    function () {
        ...
        window.dest_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'?g=Zhcms&a=Admin&c=TourDestination&m=destination&action=read',  //读取数据的URL
                    update: SITEURL+'?g=Zhcms&a=Admin&c=TourDestination&m=destination&action=save',
                    destroy: SITEURL+'?g=Zhcms&a=Admin&c=TourDestination&m=destination&action=delete'
                },
                reader: 'json'
            },
            autoLoad: true,
        ...
        window.dest_treepanel = Ext.create('Ext.tree.Panel', {
            ...
            columns: [
                {
                    text: '<span class="grid_column_text">選択</span>',
                    width: '8%',
                    dataIndex: 'issel',
                    tdCls: 'dest-al-mid',
                ...
                {
                    text: '<span class="grid_column_text">ソート</span>',
                ...
                {
                    text: '<span class="grid_column_text">開く/閉じる</span>',
                    dataIndex: 'isopen',
                    width: '14%',
                    xtype: 'actioncolumn',
                    tdCls: 'dest-al-mid',
                ...
                {
                    text: '<span class="grid_column_text">トップ表示</span>',
                    dataIndex: 'isnav',
                    width: '22%',
                    xtype: 'actioncolumn',
                    tdCls: 'dest-al-mid',
                ...
                {
                    text: '<span class="grid_column_text">hot</span>',
                    dataIndex: 'ishot',
                    width: '22%',
                    xtype: 'actioncolumn',
                    tdCls: 'dest-al-mid',
