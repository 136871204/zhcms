                                ...
                                <ul class="group clearfix">
                                    <li style="margin-right:8px; text-align:center;">
                                        <a href="<?php echo $auction['url'];?>">
                                            <img src="<?php echo $auction['goods_thumb'];?>" border="0" alt="<?php echo $auction['goods_name'];?>" style="vertical-align: middle" />
                                        </a>
                                    </li>
                                    <li style="width:555px; line-height:23px;">
                                        商品名称：<a href="<?php echo $auction['url'];?>" class="f5"><?php echo $auction['goods_name'];?></a><br />
                                        活动状态：
                                        ...
                                        <?php if($auction['end_price'] > 0){?>
                                            一口价：<?php echo $auction['formated_end_price'];?>
                                        <?php }?>
                                    </li>
                                </ul>
                            <?php $index++; ?><?php }?><?php endif;?>
