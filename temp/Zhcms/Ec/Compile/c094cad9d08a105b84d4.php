...
<head>
    ...
    <script type="text/javascript" src="http://www.metacms.com/template/v4/ec/common/js/global.js"></script>
    <script type="text/javascript" src="http://www.metacms.com/template/v4/ec/common/js/compare.js"></script>
...
<div class="block clearfix">
    <div class="f_l">
        <a href="<?php echo U('ec/EcIndex/index');?>" name="top">
            <img src="http://www.metacms.com/template/v4/ec/common/style/images/logo.gif" />
        </a>
    </div>
    <div class="f_r log">
        <ul>
    ...
    <div class="box_1">
        <h3>
            ...
            <form method="GET" class="sort" name="listform">
                显示方式：
                <a href="javascript:;" onClick="javascript:display_mode('list')"><img src="http://www.metacms.com/template/v4/ec/common/style/images/display_mode_list<?php if($pager['display'] == 'list'){?>_act<?php }?>.gif" alt="<?php echo $lang['display']['list'];?>"/></a>
                <a href="javascript:;" onClick="javascript:display_mode('grid')"><img src="http://www.metacms.com/template/v4/ec/common/style/images/display_mode_grid<?php if($pager['display'] == 'grid'){?>_act<?php }?>.gif" alt="<?php echo $lang['display']['grid'];?>"/></a>
                <a href="javascript:;" onClick="javascript:display_mode('text')"><img src="http://www.metacms.com/template/v4/ec/common/style/images/display_mode_text<?php if($pager['display'] == 'text'){?>_act<?php }?>.gif" alt="<?php echo $lang['display']['text'];?>"/></a>&nbsp;&nbsp;
                ...
                <?php if(is_array($goods_list)):?><?php $index=0; ?><?php  foreach($goods_list as $goods_key=>$goods){ ?>
                    <ul class="clearfix bgcolor"<?php if($goods_key % 2 == 0){?>id=""<?php  }else{ ?>id="bgcolor"<?php }?>>
                        ...
                        <li class="action">
                            ...
                            <a href="javascript:addToCart(<?php echo $goods['goods_id'];?>)"><img src="http://www.metacms.com/template/v4/ec/common/style/images/bnt_buy_1.gif"/></a>
                        </li>
                    </ul>
                <?php $index++; ?><?php }?><?php endif;?>
            </div>
