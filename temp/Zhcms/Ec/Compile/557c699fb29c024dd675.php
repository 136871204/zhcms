                ...
                <div class="textInfo">
                    <form action="javascript:addToCart(<?php echo $goods['goods_id'];?>)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
                        <div class="clearfix">
                            ...
                            <p class="f_r">
                                <?php if($prev_good){?>
                                    <a href="<?php echo $prev_good['url'];?>">前の商品</a>
                                <?php }?>
                                <?php if($next_good){?>
                                    <a href="<?php echo $next_good['url'];?>">次の商品</a>
                                <?php }?>
                            </p>
                        </div>
                        <ul>
                                ...
                                <li class="padd">
                                    <?php if(is_array($promotion)):?><?php $index=0; ?><?php  foreach($promotion as $promotion_key=>$item){ ?>
                                        ...
                                        <?php if($item['type'] == 'snatch'){?>
                                            <a href="<?php echo U('ec/EcSnatch/index');?>" title="商品奇襲" style="font-weight:100; color:#f69; text-decoration:none;">[商品奇襲]</a>
                                        <?php  }elseif($item['type'] == 'group_buy'){ ?>
                                            <a href="<?php echo U('ec/EcGroupBuy/index');?>" title="団体購入" style="font-weight:100; color:#f69; text-decoration:none;">[団体購入]</a>
                                        <?php  }elseif($item['type'] == 'auction'){ ?>
                                            <a href="<?php echo U('ec/EcAuction/index');?>" title="オークション" style="font-weight:100; color:#f69; text-decoration:none;">[オークション]</a>
                                        <?php  }elseif($item['type'] == 'favourable'){ ?>
                                            <a href="<?php echo U('ec/EcActivity/index');?>" title="セール" style="font-weight:100; color:#f69; text-decoration:none;">[セール]</a>
                                        <?php }?>
                            ...
                            <li class="clearfix">
                                <dd>   
                                    ...
                                    <?php if(C("ec_show_goodssn")){?>
                                        <strong>商品番号：</strong><?php echo $goods['goods_sn'];?>
                                    <?php }?>
                                </dd>
                                <dd class="ddR">
                                    <!-- 商品库存-->
                            ...
                            <li class="clearfix">
                                <dd>
                                    <?php if($goods['goods_brand'] <> '' and  C("ec_show_brand")){?>
                                        <strong>ブランド：</strong><a href="<?php echo $goods['goods_brand_url'];?>" ><?php echo $goods['goods_brand'];?></a>
                                    <?php }?>
                                </dd>
                                <dd class="ddR">
                                    <?php if(C("ec_show_goodsweight")){?>
                                        <strong>重さ：</strong><?php echo $goods['goods_weight'];?>
                                    <?php }?>
                               </dd>
                            </li>
                            <li class="clearfix">
                                <dd>
                                    <?php if(C("ec_show_addtime")){?>
                                        <strong>売り出し時間：</strong><?php echo $goods['add_time'];?>
                                    <?php }?>
                                </dd>
                                <dd class="ddR">
                                    <!--点击数-->
                                    <strong>クリック数：</strong><?php echo $goods['click_count'];?>
                                </dd>
                            </li>
                            <li class="clearfix">
                                <dd class="ddL">
                                    ...
                                    <?php if(C("ec_show_marketprice")){?>
                                        <strong>市場価格：</strong><font class="market"><?php echo $goods['market_price'];?></font><br />
                                    <?php }?>
                                    <!--本店售价-->
                                    <strong>店舗値段：</strong><font class="shop" id="ECS_SHOPPRICE"><?php echo $goods['shop_price_formated'];?></font><br />
                                     <!-- 会员等级对应的价格-->
                                ...
                                <dd style="width:48%; padding-left:7px;">
                                    <strong>コメント：</strong>
                                    <img src="http://www.metacms.com/template/v5/ec/common/style/images/stars<?php echo $goods['comment_rank'];?>.gif" alt="comment rank <?php echo $goods['comment_rank'];?>" />
                                </dd>
                            </li>
                            ...
                            <li class="clearfix">
                                ...
                                <dd class="ddR">
                                    ...
                                    <?php if($goods['give_integral'] > 0){?>
                                        <strong>この商品買うと送るポイント：</strong><font class="f4"><?php echo $goods['give_integral'];?> <?php echo $points_name;?></font>
                                    <?php }?>
                                </dd>
                            </li>
                                    ...
                                    <?php if($spec['attr_type'] == 1){?>
                                        <?php if(C("ec_goodsattr_style")== 1){?>
                                            ...
                                            <label for="spec_value_<?php echo $value['id'];?>">
                                                ...
                                                <?php echo $value['label'];?> [<?php if($value['price'] > 0){?>プラス<?php  }elseif($value['price'] < 0){ ?>マイナス<?php }?> <?php echo $value['format_price'];?>] 
                                            </label><br />
                                            <?php $index++; ?><?php }?><?php endif;?>
                                        ...
                                        <?php  }else{ ?>
                                            <select name="spec_<?php echo $spec_key;?>" onchange="changePrice()" >
                                                ...
                                                <option label="<?php echo $value['label'];?>" value="<?php echo $value['id'];?>">
                                                    <?php echo $value['label'];?> <?php if($value['price'] > 0){?>プラス<?php  }elseif($value['price'] < 0){ ?>マイナス<?php }?><?php if($value['price'] <> 0){?><?php echo $value['format_price'];?><?php }?>
                                                </option>
                                                <?php $index++; ?><?php }?><?php endif;?>
                                            </select>
                                            <input type="hidden" name="spec_list" value="<?php echo $key;?>" />
                            ...
                            <!-- 结束循环可选属性  -->
                            <li class="padd">
                                <a href="javascript:addToCart(<?php echo $goods['goods_id'];?>)">カード</a>&nbsp;&nbsp;&nbsp;
                                <a href="javascript:collect(<?php echo $goods['goods_id'];?>)">収蔵</a>
                                <?php if($affiliate['on']){?>
                                    <!--<a href="<?php echo U('ec/EcUser/index');?>&act=affiliate&goodsid=<?php echo $goods['goods_id'];?>" ><img src='http://www.metacms.com/template/v5/ec/common/style/images/bnt_recommend.gif'/></a>-->
                                <?php }?>
                            </li>
                        </ul>
                    </form>
                                    ...
                                    <?php if(is_array($package_goods_list)):?><?php $index=0; ?><?php  foreach($package_goods_list as $package_goods){ ?>
                                        ...
                                        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#dddddd">
                                            <tr>
                                                ...
                                                <td bgcolor="#FFFFFF">
                                                    <strong>元値段：</strong><font class="market"><?php echo $package_goods['subtotal'];?></font><br />
                                                    <strong>合わせ買う値段：</strong><font class="shop"><?php echo $package_goods['package_price'];?></font><br />
                                                    <strong>節約：</strong><font class="shop"><?php echo $package_goods['saving'];?></font><br />
                                                </td>
                                                <td bgcolor="#FFFFFF">
...
?>
    <div class="box">
        <div class="box_1">
            <h3>
                <span class="text">購入記録</span>
                (最近成約数<font class="f1"><?php echo $bought_notes_pager['record_count'];?></font>)
            </h3>
                ...
                <div id="buy_pagebar" class="f_r" style="margin-top:10px">
                    <form name="selectPageForm" action="" method="get">
                        ...
                        <?php if($pager['styleid'] == 0){?>
                            <div id="buy_pager">
                                総計<?php echo $bought_notes_pager['record_count'];?>個記録，全部<?php echo $bought_notes_pager['page_count'];?>ページ。 
                                <span> 
                                    <a href="<?php echo $bought_notes_pager['page_first'];?>">第一ページ</a> 
                                    <a href="<?php echo $bought_notes_pager['page_prev'];?>">前</a> 
                                    <a href="<?php echo $bought_notes_pager['page_next'];?>">次</a> 
                                    <a href="<?php echo $bought_notes_pager['page_last'];?>">一番末页</a> 
                                </span>
    ...
    <div class="blank5"></div>
                ...
                $comments_arr['id']=$id;
                ?>
                <?php if(!defined("ZHPHP_PATH"))exit;C("SHOW_NOTICE",FALSE);?><script type="text/javascript" src="http://www.metacms.com/template/v5/ec/common/js/transport_jquery.js"></script>
<script type="text/javascript" src="http://www.metacms.com/template/v5/ec/common/js/utils.js"></script>
<div id="ECS_COMMENT">
<?php
