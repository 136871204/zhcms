            ...
            <?php if(is_array($msg_lists)):?><?php $index=0; ?><?php  foreach($msg_lists as $msg){ ?>
                <div class="f_l" style="width:100%; position:relative;">
                    ...
                    <?php if($msg['comment_rank'] > 0){?>
                        <img style="position:absolute; right:0px;" src="http://www.metacms.com/template/v5/ec/common/style/images/stars<?php echo $msg['comment_rank'];?>.gif" alt="<?php echo $msg['comment_rank'];?>" />
                    <?php }?>
                </div>
