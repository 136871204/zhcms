...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="http://www.metacms.com/template/v5/ec/common/js/index.js"></script>
    </head>
    <body>
    ...
    <div class="box_2">
        ...
        <div class="top10List clearfix">
            <?php if(is_array($top_goods)):?><?php $index=0; ?><?php  foreach($top_goods as $top_goods_key=>$goods){ ?>
                ...
                <ul class="clearfix">
                    <img src="http://www.metacms.com/template/v5/ec/common/style/images/top_<?php echo $t_top_goods_key;?>.gif" class="iteration" />
                    ...
                    <li <?php if($t_top_goods_key < 4){?>class="iteration1"<?php }?>>
                        ...
                        値段：<font class="f1"><?php echo $goods['price'];?></font><br />
                    </li>
                </ul>
            <?php $index++; ?><?php }?><?php endif;?>
        </div>
...
<div class="box">
    <div class="box_1">
        <h3>
            <span>拍卖商品</span>
            <a href="<?php echo U('ec/EcAuction/index');?>"><img src="http://www.metacms.com/template/v5/ec/common/style/images/more.gif"/></a>
        </h3>
