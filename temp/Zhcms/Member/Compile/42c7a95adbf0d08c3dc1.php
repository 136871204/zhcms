...
<script src='http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/bootstrap/js/bootstrap.min.js'></script>
                ...
                <![endif]-->
    <link rel="stylesheet" type="text/css" href="http://www.metacms.com/zh/Zhcms/Member/Tpl/Follow/css/follow.css?ver=1.0"/>
    <script type='text/javascript'>
...
if($_index_d>=$_total_d):$zh["list"]["d"]["last"]=true;endif;?>
                ...
                <li>
                    <div class="icon">
                       <img src="<?php echo _default($d['icon'],'http://www.metacms.com/data/image/user/100.png');?>" onmouseover="user.show(this,<?php echo $d['uid'];?>)" style="width:100px;"/>
                    </div>
                    <div class="info">
                        <p class="nickname"><?php echo $d['nickname'];?></p>
                        <p>関係：<a href="javascript:;" onclick="user.follow(this,<?php echo $d['uid'];?>)" ><?php echo $d['follow'];?></a></p>
                        <p>最後ログイン：<?php echo date('Y-m-d',$d['logintime']);?></p>
                        <p>
                          <?php if($field['description']){?>
                                <?php echo substr($field['description'],0,20,'utf-8');?>
                                <?php  }else{ ?>
                                この人は怠け者で、個性サインもない
                            <?php }?>
                        </p>
