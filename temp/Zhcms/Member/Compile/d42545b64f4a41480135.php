...
<script src='http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/bootstrap/js/bootstrap.min.js'></script>
                ...
                <![endif]-->
    <link rel="stylesheet" type="text/css" href="http://www.metacms.com/zh/Zhcms/Member/Tpl/Message/css/message.css?ver=1.0"/>
    <script type='text/javascript'>
...
if($_index_d>=$_total_d):$zh["list"]["d"]["last"]=true;endif;?>
                ...
                <li>
                    <div class="article">
                        <a href="http://www.metacms.com/index.php?a=Member&c=Message&m=show&from_uid=<?php echo $d['from_uid'];?>" class="title">
                            <?php echo $d['nickname'];?> : <?php echo mb_substr($d['content'],0,30,'utf-8');?>
                        </a>
                    <span class="time">
                        <?php echo date('Y-m-d H:i:s',$d['sendtime']);?>
                        <?php if($d['user_message_state'] == 0){?>
