...
<script src='http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/bootstrap/js/bootstrap.min.js'></script>
                ...
                <![endif]-->
    <link rel="stylesheet" type="text/css" href="http://www.metacms.com/zh/Zhcms/Member/Tpl/SystemMessage/css/message.css?ver=1.0"/>
    <script type='text/javascript'>
...
if($_index_d>=$_total_d):$zh["list"]["d"]["last"]=true;endif;?>
                ...
                <li>
                    <div class="article" style="width:650px;">
                      <span style="float:right;font-size;12px;color:#666;"><?php echo date('Y-m-d H:i',$d['sendtime']);?></span> <?php echo $d['message'];?> 
                    </div>
                </li>
