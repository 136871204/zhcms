...
<script src='http://www.metacms.com/zh/ZHPHP/zhphp/Extend/Org/bootstrap/js/bootstrap.min.js'></script>
                ...
                <![endif]-->
    <link rel="stylesheet" type="text/css" href="http://www.metacms.com/zh/Zhcms/Member/Tpl/Dynamic/css/dynamic.css?ver=1.0"/>
    <script type='text/javascript'>
...
<article class="center-block main">
    ...
    <section class="article">
        <header>
            ...
            <h2 class="disab">
                <a href="<?php echo U('friend');?>">友達動態</a>
            </h2>
        </header>
        <ul>
                ...
                <li>
                    <div class="article">
                    	<a href="http://www.metacms.com/index.php?<?php echo $d['domain'];?>">
                      		<img src="<?php echo _default($d['icon'],'http://www.metacms.com/data/image/user/50.png');?>" onmouseover="user.show(this,<?php echo $d['uid'];?>)"/>
                      	</a>
                      	<a href="http://www.metacms.com/index.php?<?php echo $d['domain'];?>">
                      		<?php echo $d['username'];?>
                      	</a>
