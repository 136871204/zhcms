                        ...
                        <h3>
                            ...
                            <?php if($goods_list){?>
                                <form action="<?php echo U('index');?>" method="post" class="sort" name="listform" id="form">
                                    显示方式
                                    <a href="javascript:;" onClick="javascript:display_mode('list')"><img src="http://www.works.com/template/v4/ec/common/style/images/display_mode_list<?php if($pager['display'] == 'list'){?>_act<?php }?>.gif" alt="列表显示"/></a>
                                    <a href="javascript:;" onClick="javascript:display_mode('grid')"><img src="http://www.works.com/template/v4/ec/common/style/images/display_mode_grid<?php if($pager['display'] == 'grid'){?>_act<?php }?>.gif" alt="格子显示"/></a>
                                    <a href="javascript:;" onClick="javascript:display_mode('text')"><img src="http://www.works.com/template/v4/ec/common/style/images/display_mode_text<?php if($pager['display'] == 'text'){?>_act<?php }?>.gif" alt="文字显示"/></a>&nbsp;&nbsp;
                                    <select name="sort">
