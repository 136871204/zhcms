    ...
    document.getElementById('history_list').innerHTML = '<?php echo $lang['no_history'];?>';
        ...
        <div class="AreaR">
            ...
            <div id="brandList" class="clearfix">
                <?php if(is_array($brand_list)):?><?php $index=0; ?><?php  foreach($brand_list as $brand_list_foreach=>$brand_data){ ?>
                    <div class="brandBox">
                        <h4><span><?php echo $brand_data['brand_name'];?></span>(<?php echo $brand_data['goods_num'];?>)</h4>
                        <?php if($brand_data['brand_logo']){?>
                            <div class="brandLogo">
                                <a href="<?php echo $brand_data['url'];?>">
                                    <img src="<?php echo $brand_data['brand_logo'];?>" alt="<?php echo $brand_data['brand_name'];?> (<?php echo $brand_data['goods_num'];?>)" />
                                </a>
    				        </div>
                        <?php }?>
                        <p title="<?php echo $brand_data['brand_desc'];?>"><?php echo $brand_data['brand_desc'];?></p> 
                    </div>
                <?php $index++; ?><?php }?><?php endif;?>
            </div>
            <div class="blank5"></div>
