                            ...
                            <?php if(is_array($condition)):?><?php $index=0; ?><?php  foreach($condition as $caption){ ?>
                                <tr>
                                    <td bgcolor="#e5ecfb" style="border-bottom: 1px solid #DADADA">
                                        <img src="http://www.works.com/template/v4/ec/common/style/images/note.gif" alt="no alt" />
                                        &nbsp;&nbsp;
                    ...
                    <div class="boxCenterList clearfix">
                        <?php if(is_array($pickout_goods)):?><?php $index=0; ?><?php  foreach($pickout_goods as $goods){ ?>
                            <div class="goodsItem">
                                ...
                                <a href="javascript:addToCart(<?php echo $goods['id'];?>)">
                                    <img src="http://www.works.com/template/v4/ec/common/style/images/bnt_buy.gif" />
                                </a> 
                                <a href="javascript:collect(<?php echo $goods['id'];?>)">
                                    <img src="http://www.works.com/template/v4/ec/common/style/images/bnt_coll.gif" />
                                </a>
                                <font class="f1">
                        ...
                        <?php if($count > 5){?>
                            <div class="more f_r" style="clear:both;">
                                <a href="<?php echo $url;?>"><img src="http://www.works.com/template/v4/ec/common/style/images/more.gif" /></a>
                            </div>
                        <?php }?>
                    </div>
                </div>
