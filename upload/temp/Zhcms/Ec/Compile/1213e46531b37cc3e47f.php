...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="http://www.works.com/template/v4/ec/common/js/index.js"></script>
    </head>
    <body>
...
<?php }?>
    ...
    <div class="brandsMore">
        <a href="<?php echo U('ec/EcBrand/index');?>">
            <img src="http://www.works.com/template/v4/ec/common/style/images/moreBrands.gif" />
        </a>
    </div>
<?php }?>
                        </div>
...
<div class="box">
    <div class="box_1">
        <h3>
            <span>团购商品</span>
            <a href="<?php echo U('ec/EcGroupBuy/index');?>"><img src="http://www.works.com/template/v4/ec/common/style/images/more.gif"/></a>
        </h3>
        <div class="centerPadd">
            <div class="clearfix goodsBox" style="border:none;">
