...
?>
                                            ...
                                            <tr>
                                                <td width="28%" align="right" bgcolor="#FFFFFF" <?php if($field['is_need']){?>id="passwd_quesetion"<?php }?>>密码问题答案：</td>
                                                <td width="72%" align="left" bgcolor="#FFFFFF">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" align="center" bgcolor="#ffffff">
                                                <?php if($consignee['consignee'] and  $consignee['email']){?>
                                                    ...
                                                    <input name="button" type="button" class="bnt_blue"  onclick="if (confirm('你确认要删除该收货地址吗？'))location.href='<?php echo U('index');?>&act=drop_consignee&id=<?php echo $consignee['address_id'];?>'" value="删除" />
                                                <?php  }else{ ?>
