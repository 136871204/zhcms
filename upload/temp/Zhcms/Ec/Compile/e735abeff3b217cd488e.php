            ...
            <div class="box">
                <div class="box_1">
                    ...
                    <div class="boxCenterList">
                        <form action="<?php echo $search_url;?>" name="search_form" method="post" class="article_search">
                            <input name="keywords" type="text" id="requirement" value="<?php echo $search_value;?>" class="inputBg" />
                            <input name="id" type="hidden" value="<?php echo $cat_id;?>" />
                            <input name="cur_url" id="cur_url" type="hidden" value="" />
                            <input type="submit" value="立刻搜索" class="bnt_blue_1" />
                        </form>
                        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                            ...
                            <?php if(is_array($artciles_list)):?><?php $index=0; ?><?php  foreach($artciles_list as $article){ ?>
                            <tr>
                                <td bgcolor="#ffffff"><a href="<?php echo $article['url'];?>" title="<?php echo $article['title'];?>" class="f6"><?php echo $article['short_title'];?></a></td>
                                <td bgcolor="#ffffff"><?php echo $article['author'];?></td>
                                <td bgcolor="#ffffff" align="center"><?php echo $article['add_time'];?></td>
                            </tr>
                            <?php $index++; ?><?php }?><?php endif;?>
                        </table>
                    </div>
