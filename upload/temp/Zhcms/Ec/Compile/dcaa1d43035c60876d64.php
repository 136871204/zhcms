...
<!--search end-->
    ...
    <div class="blank"></div>
    <div class="block">
        <h5><span>超值礼包</span></h5>
        <div class="blank"></div>
        <?php if(is_array($list)):?><?php $index=0; ?><?php  foreach($list as $val){ ?>
            <a name="<?php echo $val['act_id'];?>"></a>
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                <tr>
                    <th bgcolor="#ffffff">超值礼包名称:</th>
                    <td colspan="3" bgcolor="#ffffff"><?php echo $val['act_name'];?></td>
                </tr>
                <tr>
                    <th bgcolor="#ffffff">开始时间:</th>
                    <td width="200" bgcolor="#ffffff"><?php echo $val['start_time'];?></td>
                    <th bgcolor="#ffffff">原始价格:</th>
                    <td bgcolor="#ffffff"><?php echo $val['subtotal'];?></td>
                </tr>
                <tr>
                    <th bgcolor="#ffffff">结束时间:</th>
                    <td bgcolor="#ffffff"><?php echo $val['end_time'];?></td>
                    <th bgcolor="#ffffff">礼包价格:</th>
                    <td bgcolor="#ffffff"><?php echo $val['package_price'];?></td>
                </tr>
                <tr>
                    <th bgcolor="#ffffff">心动不如行动:</th>
                    <td bgcolor="#ffffff">
                        <a href="javascript:addPackageToCart(<?php echo $val['act_id'];?>)" style="background:transparent">
                            <img src="http://www.works.com/template/v4/ec/common/style/images/bnt_buy_1.gif" alt="<?php echo $lang['add_to_cart'];?>" />
                        </a>
                    </td>
                    <th bgcolor="#ffffff">立即节省:</th>
                    <td width="200" bgcolor="#ffffff"><?php echo $val['saving'];?></td>
                </tr>
                <tr>
                    <th bgcolor="#ffffff">该礼包的商品:</th>
                    <td colspan="3" bgcolor="#ffffff">
                        <?php if(is_array($val['goods_list'])):?><?php $index=0; ?><?php  foreach($val['goods_list'] as $goods){ ?>
                            <a href="goods.php?id=<?php echo $goods['goods_id'];?>" target="_blank" class="f6">
                                <span class="f_user_info"><u><?php echo $goods['goods_name'];?></u></span>
                            </a> &nbsp;X &nbsp;<?php echo $goods['goods_number'];?><br />
                        <?php $index++; ?><?php }?><?php endif;?>
                    </td>
                </tr>
                <tr>
                    <th bgcolor="#ffffff">详细描述:</th>
                    <td colspan="3" bgcolor="#ffffff"><?php echo $val['act_desc'];?></td>
                </tr>
            </table>
