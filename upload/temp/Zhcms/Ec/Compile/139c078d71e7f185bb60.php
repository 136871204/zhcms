        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            ...
            <?php if(count($goods_list) > 2){?>
                <tr>
                    ...
                    <?php if(is_array($goods_list)):?><?php $index=0; ?><?php  foreach($goods_list as $goods_list_foreach=>$goods){ ?>
                        <th bgcolor="#ffffff">
                            <a href="javascript:remove(<?php echo $goods['goods_id'];?>,'<?php echo U('index');?>&<?php echo $goods['ids'];?>');" >移除</a>
                        </th>
                    <?php $index++; ?><?php }?><?php endif;?>
                </tr>
            <?php }?>
            <tr>
                <th align="left" bgcolor="#ffffff">&nbsp;&nbsp;品牌</th>
                <?php if(is_array($goods_list)):?><?php $index=0; ?><?php  foreach($goods_list as $goods_list_foreach=>$goods){ ?>
                    <td bgcolor="#ffffff">&nbsp;&nbsp;<?php echo $goods['brand_name'];?></td>
                <?php $index++; ?><?php }?><?php endif;?>
            </tr>
            <tr>
                <th align="left" bgcolor="#ffffff">&nbsp;&nbsp;本店售价：</th>
                <?php if(is_array($goods_list)):?><?php $index=0; ?><?php  foreach($goods_list as $goods_list_foreach=>$goods){ ?>
                    <td bgcolor="#ffffff">&nbsp;&nbsp;<?php echo $goods['rank_price'];?></td>
                <?php $index++; ?><?php }?><?php endif;?>
            </tr>
            <tr>
                <th align="left" bgcolor="#ffffff">&nbsp;&nbsp;商品重量：</th>
                <?php if(is_array($goods_list)):?><?php $index=0; ?><?php  foreach($goods_list as $goods_list_foreach=>$goods){ ?>
            ...
            <?php $index++; ?><?php }?><?php endif;?>
            <tr>
                <td align="left" bgcolor="#ffffff">&nbsp;&nbsp;<strong>用户评价：</strong></td>
                <?php if(is_array($goods_list)):?><?php $index=0; ?><?php  foreach($goods_list as $goods_list_foreach=>$goods){ ?>
                    <td bgcolor="#ffffff">
                        &nbsp;&nbsp;
                        <span class="goods-price">
                            <img src="http://www.works.com/template/v4/ec/common/style/images/stars<?php echo $goods['comment_rank'];?>.gif" width="64" height="12" alt="comment rank <?php echo $goods['comment_rank'];?>" />
                        </span><br />
                    </td>
                <?php $index++; ?><?php }?><?php endif;?>
            </tr>
            <tr>
                <td align="left" bgcolor="#ffffff">&nbsp;&nbsp;<strong>简要介绍：</strong></td>
                <?php if(is_array($goods_list)):?><?php $index=0; ?><?php  foreach($goods_list as $goods_list_foreach=>$goods){ ?>
                ...
                <?php if(is_array($goods_list)):?><?php $index=0; ?><?php  foreach($goods_list as $goods_list_foreach=>$goods){ ?>
                    <td align='center' bgcolor="#ffffff">
                        <a href="javascript:collect(<?php echo $goods['goods_id'];?>);">
                            <img src="http://www.works.com/template/v4/ec/common/style/images/bnt_colles.gif" alt="加入收藏夹"  style="margin:2px auto;"/>
                        </a>
                        <a href="javascript:addToCart(<?php echo $goods['goods_id'];?>)">
                            <img src="http://www.works.com/template/v4/ec/common/style/images/bnt_cat.gif" alt="加入购物车"  style="margin:2px auto;"/>
                        </a>
                    </td>
                <?php $index++; ?><?php }?><?php endif;?>
            </tr>
