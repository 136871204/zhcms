...
<head>
    ...
    <?php if($auto_redirect){?>
        <meta http-equiv="refresh" content="3;URL=<?php echo $message['back_url'];?>" />
    <?php }?>
            ...
            <div class="box_1">
                ...
                <div class="boxCenterList RelaArticle" align="center">
                    <div style="margin:20px auto;">
                        ...
                        <div class="blank"></div>
                            <?php if($message['url_info']){?>
                                <?php if(is_array($message['url_info'])):?><?php $index=0; ?><?php  foreach($message['url_info'] as $info_key=>$url){ ?>
                                    <p><a href="<?php echo $url;?>"><?php echo $info_key;?></a></p>
                                <?php $index++; ?><?php }?><?php endif;?>
                            <?php }?>
                    </div>
                </div>
