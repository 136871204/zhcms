...
<?php }?>
    ...
    <?php if($cat_rec_sign <> 1){?>
        <div class="xm-box">
            <h4 class="title"><span>新品上架</span> <a class="more" href="<?php echo U('ec/EcSearch/index');?>&intro=new">更多</a></h4>
...
<?php }?>
    ...
    <?php if($cat_rec_sign <> 1){?>
        <div class="xm-box">
            <h4 class="title"><span>精品推荐</span> <a class="more" href="<?php echo U('ec/EcSearch/index');?>&intro=best">更多</a></h4>
