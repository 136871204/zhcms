...
<div class="blank"></div>
    ...
    <div class="block">
        <div class="flowBox">
            ...
            <form action="<?php echo U('index');?>" method="post" name="searchForm" target="_blank" class="quotation">
                <!-- 分类 -->
...
?>
                ...
                <!-- 关键字 -->
                关键字 <input type="text" name="keyword" class="inputBg" style="vertical-align:middle;"/>
                <!-- 搜索 -->
