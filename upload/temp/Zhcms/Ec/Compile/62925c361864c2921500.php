                            ...
                            <?php if($goods_list){?>
                                <form action="<?php echo U('index');?>" method="post" class="sort" name="listform" id="form">
                                    ...
                                    <a href="javascript:;" onClick="javascript:display_mode('list')">
                                        <img src="http://www.works.com/template/v3/ec/common/images/display_mode_list<?php if($pager['display'] == 'list'){?>_act<?php }?>.gif" alt="列表显示"/>
                                    </a>
                                    <a href="javascript:;" onClick="javascript:display_mode('grid')">
                                        <img src="http://www.works.com/template/v3/ec/common/images/display_mode_grid<?php if($pager['display'] == 'grid'){?>_act<?php }?>.gif" alt="格子显示"/>
                                    </a>
                                    <a href="javascript:;" onClick="javascript:display_mode('text')">
                                        <img src="http://www.works.com/template/v3/ec/common/images/display_mode_text<?php if($pager['display'] == 'text'){?>_act<?php }?>.gif" alt="文字显示"/>
                                    </a>&nbsp;&nbsp;
                                    <select name="sort">
...
?>
                                    ...
                                    <input type="image" name="imageField" src="http://www.works.com/template/v3/ec/common/images/bnt_go.gif" alt="go"/>
                        ...
                        <?php if($goods_list){?>
                            <form action="<?php echo U('ec/EcCompare/index');?>" method="post" name="compareForm" id="compareForm" onsubmit="return compareGoods(this);">
                                ...
                                <?php  }elseif($pager['display'] == 'text'){ ?>
                                    <div class="goodsList">
                                        <?php if(is_array($goods_list)):?><?php $goods_list_name=0; ?><?php  foreach($goods_list as $goods){ ?>
                                            <ul class="clearfix bgcolor"<?php if($goods_list_name % 2 == 0){?>id=""<?php  }else{ ?>id="bgcolor"<?php }?>>
                                                ...
                                                <li>
                                                    ...
                                                    <?php if($goods['promote_price'] <> ''){?>
                                                        促销价：<font class="shop"><?php echo $goods['promote_price'];?></font><br /><br />
                                                    <?php  }else{ ?>
                                        ...
                                        <?php $goods_list_name++; ?><?php }?><?php endif;?>
                                    </div>
                                <?php }?>
                            </form>
                            <script type="text/javascript">
