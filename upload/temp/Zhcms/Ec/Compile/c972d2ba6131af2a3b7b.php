                ...
                <div class="box_1">
                    <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
                        ...
                        <?php if($action == 'default'){?>
                            <font class="f5"><b class="f4"><?php echo $info['username'];?></b> 欢迎您回到 <?php echo $info['shop_name'];?>！</font><br />
                            <div class="blank"></div>
                            您的上一次登录时间: <?php echo $info['last_time'];?><br />
                            ...
                            <div style="margin:5px 0; border:1px solid #a1675a;padding:10px 20px; background-color:#e8d1c9;">
                                <img src="http://www.works.com/template/v4/ec/common/style/images/note.gif" alt="note" />&nbsp;<?php echo $user_notice;?>
                            </div>
                            <br /><br />
                            <div class="f_l" style="width:350px;">
                                <h5><span>您的账户</span></h5>
                                <div class="blank"></div>
                                余额:<a href="<?php echo U('index');?>&act=account_log" style="color:#006bd0;"><?php echo $info['surplus'];?></a><br />
                                <!-- 如果有信用额度 -->
                                <?php if($info['credit_line'] > 0){?>
                                    信用额度:<?php echo $info['formated_credit_line'];?><br />
                                <?php }?>
                                红包:<a href="<?php echo U('index');?>&act=bonus" style="color:#006bd0;"><?php echo $info['bonus'];?></a><br />
                                积分:<?php echo $info['integral'];?><br />
                            </div>
                            <div class="f_r" style="width:350px;">
                                ...
                                <?php $index++; ?><?php }?><?php endif;?>
                                您最近30天内提交了<?php echo $info['order_count'];?>个订单<br />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href ="<?php echo $order_info['url'];?>">
                                                    <img src="http://www.works.com/template/v4/ec/common/style/images/note.gif" /><?php echo $order_info['order_sn'];?>
                                                </a>
                            ...
                            <?php if($tags){?>
                                ...
                                <?php if(is_array($tags)):?><?php $index=0; ?><?php  foreach($tags as $tag){ ?>
                                    ...
                                    <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($tag['tag_words']);?>" onclick="if (!confirm('您确认要删除此标签吗？')) return false;" title="删除">
                                        <img src="http://www.works.com/template/v4/ec/common/style/images/drop.gif" alt="删除" />
                                    </a>&nbsp;&nbsp;
                                <?php $index++; ?><?php }?><?php endif;?>
                            <?php  }else{ ?>
                        ...
                        <?php if($action == 'comment_list'){?>
                            ...
                            <?php if($comment_list){?>
                                <?php if(is_array($comment_list)):?><?php $index=0; ?><?php  foreach($comment_list as $comment){ ?>
                                    ...
                                    <div class="f_r">
                                        <a href="user.php?act=del_cmt&amp;id=<?php echo $comment['comment_id'];?>" title="删除" onclick="if (!confirm('你确实要彻底删除这条留言吗？')) return false;" class="f6">删除</a>
                                    </div>
                                    <div class="msgBottomBorder">
