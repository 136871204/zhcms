...
<div style="clear:both"></div>
    ...
    <div class="form-div">
        <form method="post" action="javascript:newVoteOption()" name="theForm">
            添加调查选项：<input type="text" name="option_name" maxlength="100" size="30" />
        ...
        <table cellspacing='1' cellpadding='3' id='listTable'>
            ...
            <?php if(!empty($option_arr)){?>
                ...
                <tr align="center">
                    ...
                    <td>
                        <a href="javascript:;" onclick="listTable.remove(<?php echo $list['option_id'];?>, '您确认要删除这条记录吗?', 'remove_option')" title="移除">
