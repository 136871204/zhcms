    ...
    <form method="post" action="<?php echo U('index');?>" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                ...
                <td>
                    <input type="text" name="suppliers_name" maxlength="60" value="<?php echo $suppliers['suppliers_name'];?>" />
                    <span class="require-field">*</span>
                </td>
            </tr>
            <tr>
                <td class="label">供货商描述：</td>
                <td><textarea  name="suppliers_desc" cols="60" rows="4"  ><?php echo $suppliers['suppliers_desc'];?></textarea></td>
            </tr>
            <tr>
                <td class="label">
                ...
                <td>
                    <?php if(is_array($suppliers['admin_list'])):?><?php $index=0; ?><?php  foreach($suppliers['admin_list'] as $admin){ ?>
        ...
        <table align="center">
            <tr>
                <td colspan="2" align="center">
                    ...
                    <input type="hidden" name="id" value="<?php echo $suppliers['suppliers_id'];?>" />
                </td>
            </tr>
        </table>
    </form>
