...
<?php }?>
            <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
                <tr>
                    <th><?php echo L("admin_eccategory_category_list_page_table_th1");?></th>
                    <th><?php echo L("admin_eccategory_category_list_page_table_th2");?></th>
                    <th><?php echo L("admin_eccategory_category_list_page_table_th3");?></th>
                    <th><?php echo L("admin_eccategory_category_list_page_table_th4");?></th>
                    <th><?php echo L("admin_eccategory_category_list_page_table_th5");?></th>
                    <th><?php echo L("admin_eccategory_category_list_page_table_th6");?></th>
                    <th><?php echo L("admin_eccategory_category_list_page_table_th7");?></th>
                    <th><?php echo L("admin_eccategory_category_list_page_table_th8");?></th>
                </tr>
                    ...
                    <tr align="center" class="<?php echo $cat['level'];?>" id="<?php echo $cat['level'];?>_<?php echo $cat['cat_id'];?>">
                        <td align="left" class="first-cell" >
                            <?php if($cat['is_leaf'] <> 1){?>
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/menu_minus.gif" id="icon_<?php echo $cat['level'];?>_<?php echo $cat['cat_id'];?>" width="9" height="9" border="0" style="margin-left:<?php echo $cat['level'];?>em" onclick="rowClicked(this)" />
                            <?php  }else{ ?>
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/menu_arrow.gif" width="9" height="9" border="0" style="margin-left:<?php echo $cat['level'];?>em" />
                            <?php }?>
                        ...
                        <td width="10%">
                            <?php if($cat['show_in_nav'] == '1'){?>
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/yes.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', <?php echo $cat['cat_id'];?>)"/>
                            <?php  }else{ ?>
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/no.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', <?php echo $cat['cat_id'];?>)"/>
                            <?php }?>
                        </td>
                        <td width="10%">
                            <?php if($cat['is_show'] == '1'){?>
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/yes.gif" onclick="listTable.toggle(this, 'toggle_is_show', <?php echo $cat['cat_id'];?>)"/>
                            <?php  }else{ ?>
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/no.gif" onclick="listTable.toggle(this, 'toggle_is_show', <?php echo $cat['cat_id'];?>)"/>
                            <?php }?>
                        </td>
                        ...
                        <td width="24%" align="center">
                          <a href="<?php echo U('index',array('act'=>'move','cat_id'=>$cat['cat_id']));?>"><?php echo L("admin_eccategory_category_list_page_table_info1");?></a> |
                          <a href="<?php echo U('index',array('act'=>'edit','cat_id'=>$cat['cat_id']));?>"><?php echo L("admin_eccategory_category_list_page_table_info2");?></a> |
                          <a href="javascript:;" onclick="listTable.remove(<?php echo $cat['cat_id'];?>, '<?php echo L("admin_eccategory_category_list_page_table_info3");?>')" title="<?php echo L("admin_eccategory_category_list_page_table_info4");?>"><?php echo L("admin_eccategory_category_list_page_table_info4");?></a>
                        </td>
                    </tr>
                    <?php $index++; ?><?php }?><?php endif;?>
                <?php  }else{ ?>
                    <tr><td class="no-records" colspan="10"><?php echo L("admin_eccategory_category_list_page_table_info5");?></td></tr>
                <?php }?>
...
imgPlus.src = "http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/menu_plus.gif";
...
function rowClicked(obj)
{
    ...
    for (i = 0; i < obj.cells[0].childNodes.length; i++)
    {
        ...
        if (imgObj.tagName == "IMG" && imgObj.src != 'http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/menu_arrow.gif')
        {
            imgObj.src = (imgObj.src == imgPlus.src) ? 'http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/menu_minus.gif' : imgPlus.src;
        }
    }
}
