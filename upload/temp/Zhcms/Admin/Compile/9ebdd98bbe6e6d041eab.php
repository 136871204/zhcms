...
<?php }?>
            <table cellpadding="3" cellspacing="1">
                <tr>
                    <th><a href="javascript:listTable.sort('link_name'); ">链接名称</a><?php echo $sort_link_name;?></th>
                    <th><a href="javascript:listTable.sort('link_url'); ">链接地址</a><?php echo $sort_link_url;?></th>
                    <th><a href="javascript:listTable.sort('link_logo'); ">链接LOGO</a><?php echo $sort_link_logo;?></th>
                    <th><a href="javascript:listTable.sort('show_order'); ">显示顺序</a><?php echo $sort_show_order;?></th>
                    <th>操作</th>
                </tr>
                <?php if(!empty($links_list)){?>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <span>
                                <a href="<?php echo U('index');?>&act=edit&id=<?php echo $link['link_id'];?>" title="编辑">
                                    <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_edit.gif" border="0" height="16" width="16" />
                                </a>&nbsp;
                                <a href="javascript:;" onclick="listTable.remove(<?php echo $link['link_id'];?>, '您确认要删除这条记录吗?')" title="移除">
