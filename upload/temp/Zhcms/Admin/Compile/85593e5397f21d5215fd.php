...
<?php }?>
            <table width="100%" cellpadding="3" cellspacing="1" id="listTable">
                <tr>
                    <th><?php echo L("admin_ecgoodstype_page_table_th1");?></th>
                    <th><?php echo L("admin_ecgoodstype_page_table_th2");?></th>
                    <th><?php echo L("admin_ecgoodstype_page_table_th3");?></th>
                    <th><?php echo L("admin_ecgoodstype_page_table_th4");?></th>
                    <th><?php echo L("admin_ecgoodstype_page_table_th5");?></th>
                </tr>
                <?php if(!empty($goods_type_arr)){?>
                    ...
                    <tr>
                        ...
                        <td align="center"><img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($goods_type['enabled']){?>yes<?php  }else{ ?>no<?php }?>.gif" ></td>
                        <td align="center">
                             <a href="<?php echo U('Admin/EcAttribute/index',array('act'=>'list','goods_type'=>$goods_type['cat_id']));?>" title="<?php echo L("admin_ecgoodstype_page_table_td1");?>"><?php echo L("admin_ecgoodstype_page_table_td1");?></a> |
                             <a href="<?php echo U('index',array('act'=>'edit','cat_id'=>$goods_type['cat_id']));?>" title="<?php echo L("admin_ecgoodstype_page_table_td2");?>"><?php echo L("admin_ecgoodstype_page_table_td2");?></a> |
                             <a href="javascript:;" onclick="listTable.remove(<?php echo $goods_type['cat_id'];?>, '<?php echo L("admin_ecgoodstype_page_table_td3");?>')" title="<?php echo L("admin_ecgoodstype_control_index_list9");?>"><?php echo L("admin_ecgoodstype_control_index_list9");?></a>
                        </td>
                    </tr>
                    <?php $index++; ?><?php }?><?php endif;?>
                <?php  }else{ ?>
                    <tr><td class="no-records" colspan="10"><?php echo L("admin_ecgoodstype_page_table_td4");?></td></tr>
                <?php }?>
                <tr>
