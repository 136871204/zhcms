    ...
    <form action="<?php echo U('index');?>" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="can_multi" value="0" <?php if($vote_arr['can_multi'] == 0){?> checked="true" <?php }?>/>能
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="can_multi" value="1"<?php if($vote_arr['can_multi'] == 1){?> checked="true" <?php }?>/>不能
                </td>
            </tr>
            <tr>
                <td class="label">&nbsp;</td>
