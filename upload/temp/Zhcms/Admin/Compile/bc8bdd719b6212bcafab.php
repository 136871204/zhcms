                ...
                <?php if(!empty($article_list)){?>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <?php if($list['cat_id'] > 0){?>
                                <span>
                                    <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($list['is_open'] == 1){?>yes<?php  }else{ ?>no<?php }?>.gif" onclick="listTable.toggle(this, 'toggle_show', <?php echo $list['article_id'];?>)" />
                                </span>
                            <?php  }else{ ?>
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/yes.gif" alt="yes" />
                            <?php }?>
                        </td>
