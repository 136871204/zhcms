...
<div class="form-div">
    <strong>拍卖活动名称：</strong><?php echo $auction['act_name'];?> 
    <strong>拍卖商品名称：</strong><?php echo $auction['goods_name'];?>
    <a href="<?php echo U('index');?>&act=edit&id=<?php echo $auction['act_id'];?>"> [ 查看 ] </a>
</div>
...
<div class="list-div" id="listDiv">
    <table cellpadding="3" cellspacing="1">
        ...
        <?php if(!empty($auction_log)){?>
            <?php if(is_array($auction_log)):?><?php $fe_log=0; ?><?php  foreach($auction_log as $log){ ?>
                <tr>
                    <td><?php echo $log['user_name'];?></td>
                    <td align="right"><?php echo $log['formated_bid_price'];?></td>
                    <td align="center"><?php echo $log['bid_time'];?></td>
                    <td align="center">
                        <?php if($fe_log == 0){?>
                        OK
                        <?php  }else{ ?>
