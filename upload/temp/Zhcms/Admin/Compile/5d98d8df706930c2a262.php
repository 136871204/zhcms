...
<head>
    ...
    <title><?php echo L("admin_node_edit_page_title");?></title>
...
<form action="<?php echo U('edit');?>" method="post" class="zh-form" onsubmit="return zh_submit(this,'<?php echo U(index);?>')">
    ...
    <div class="wrap">
        <div class="menu_list">
            <ul>
                <li><a href="<?php echo U('index');?>"><?php echo L("admin_node_edit_page_tab1");?></a></li>
                <li><a href="javascript:;" class="action"><?php echo L("admin_node_edit_page_tab2");?></a></li>
                <li><a href="javascript:hd_ajax('<?php echo U(update_cache);?>');"><?php echo L("admin_node_edit_page_tab3");?></a></li>
            </ul>
        </div>
        <div class="title-header">
            <?php echo L("admin_node_edit_page_table_header");?>
        </div>
        <table class="table1">
            <tr>
                <td class="w100"><?php echo L("admin_node_edit_page_table_item1");?>:</td>
                <td class="pid">
                    <select name="pid">
                        <option value="0"><?php echo L("admin_node_edit_page_table_item1_show1");?></option>
...
<?php echo $n['level'];?><br/>
                            <?php if($n['_level'] < 3){?>
                                <option value="<?php echo $n['nid'];?>" <?php echo $n['disabled'];?> <?php if($n['nid']==$field['pid']){?>selected="selected"<?php }?>><?php echo $n['_name'];?></option>
                            <?php }?>
...
echo "";
            ...
            <tr>
                <td><?php echo L("admin_node_edit_page_table_item7");?>:</td>
                <td>
                    <textarea name="comment" class="w350 h100"><?php echo $field['comment'];?></textarea>
                </td>
            </tr>
            <tr>
                <td><?php echo L("admin_node_edit_page_table_item8");?>:</td>
                <td>
                    <label>
                        <input type="radio" name="state" value="1" <?php if($field['state']==1){?>checked="checked"<?php }?>/> <?php echo L("admin_node_edit_page_table_item8_show1");?>
                    </label>
                    <label>
                        <input type="radio" name="state" value="0" <?php if($field['state']==0){?>checked="checked"<?php }?>/> <?php echo L("admin_node_edit_page_table_item8_show2");?>
                    </label>
                </td>
            </tr>
            <tr>
                <td><?php echo L("admin_node_edit_page_table_item9");?>:</td>
                <td>
                    <select name="type">
                        <option value="1" <?php if($field['status']==1){?>checked="checked"<?php }?>><?php echo L("admin_node_edit_page_table_item9_show1");?></option>
                        <option value="2" <?php if($field['status']==2){?>checked="checked"<?php }?>><?php echo L("admin_node_edit_page_table_item9_show2");?></option>
                    </select>
                </td>
            </tr>
        </table>
    ...
    <div class="position-bottom">
        <input type="submit" value="<?php echo L("admin_node_edit_page_form_submit");?>" class="zh-success"/>
    </div>
</form>
</body>
</html>