            ...
            <table cellpadding="3" cellspacing="1">
                ...
                <?php if(!empty($suppliers_list)){?>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($suppliers['is_check'] == 1){?>yes<?php  }else{ ?>no<?php }?>.gif" onclick="listTable.toggle(this, 'is_check', <?php echo $suppliers['suppliers_id'];?>)" style="cursor:pointer;"/>
                        </td>
                        <td align="center">
