            ...
            <table cellpadding="3" cellspacing="1">
                <tr>
                    <th>
                        ...
                        <a href="javascript:listTable.sort('tag_id'); ">编号</a><?php echo $sort_tag_id;?>
                    </th>
                    <th><a href="javascript:listTable.sort('tag_words'); ">标签名称</a><?php echo $sort_tag_words;?></th>
                    <th><a href="javascript:listTable.sort('user_name'); ">会员名</a><?php echo $sort_user_name;?></th>
                    <th><a href="javascript:listTable.sort('goods_name'); ">商品名称</a><?php echo $sort_goods_name;?></th>
                    <th>操作</th>
                </tr>
                <?php if(!empty($tag_list)){?>
                    <?php if(is_array($tag_list)):?><?php $index=0; ?><?php  foreach($tag_list as $tag){ ?>
                        <tr>
                            <td><span><input name="checkboxes[]" type="checkbox" value="<?php echo $tag['tag_id'];?>"/><?php echo $tag['tag_id'];?></span></td>
                            <td class="first-cell"><span onclick="javascript:listTable.edit(this, 'edit_tag_name', <?php echo $tag['tag_id'];?>)"><?php echo $tag['tag_words'];?></span></td>
                            <td align="left"><span><?php echo $tag['user_name'];?></span></td>
                            <td align="left"><span><a href="../goods.php?id=<?php echo $tag['goods_id'];?>" target="_blank"><?php echo $tag['goods_name'];?></a></span></td>
                            <td align="center">
                                <span>
                                    <a href="<?php echo U('index');?>&amp;act=edit&amp;id=<?php echo $tag['tag_id'];?>" title="编辑">
                                        <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_edit.gif" border="0" height="16" width="16" />
                                    </a>
                                    <a href="javascript:;" onclick="listTable.remove(<?php echo $tag['tag_id'];?>, '您确定要删除这条记录吗?')" title="移除">
