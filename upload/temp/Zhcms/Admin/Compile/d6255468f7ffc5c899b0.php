            ...
            <table cellpadding="3" cellspacing="1">
                ...
                <?php if(!empty($wholesale_list)){?>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($wholesale['enabled']){?>yes<?php  }else{ ?>no<?php }?>.gif" onclick="listTable.toggle(this, 'toggle_enabled', <?php echo $wholesale['act_id'];?>)" />
                        </td>
                        <td align="center">
