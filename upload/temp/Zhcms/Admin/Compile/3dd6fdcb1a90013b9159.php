            ...
            <table cellpadding="3" cellspacing="1">
                ...
                <?php if(!empty($lists)){?>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="<?php echo U('index');?>&act=option&id=<?php echo $list['vote_id'];?>" title="调查选项">
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_view.gif" border="0" height="16" width="16" />
                            </a>&nbsp;
                            <a href="<?php echo U('index');?>&act=edit&id=<?php echo $list['vote_id'];?>" title="编辑">
                                <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/icon_edit.gif" border="0" height="16" width="16" />
                            </a>&nbsp;
                            <a href="javascript:;" onclick="listTable.remove(<?php echo $list['vote_id'];?>, '您确认要删除这条记录吗?')" title="移除">
