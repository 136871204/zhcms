            ...
            <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
                ...
                <?php if(!empty($articlecat)){?>
                    ...
                    <tr align="center" class="<?php echo $cat['level'];?>" id="<?php echo $cat['level'];?>_<?php echo $cat['cat_id'];?>">
                        ...
                        <td width="10%" class="nowrap" valign="top"><img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($cat['show_in_nav'] == '1'){?>yes<?php  }else{ ?>no<?php }?>.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', <?php echo $cat['cat_id'];?>)" /></td>
