...
<?php }?>
            <table cellspacing='1' id="list-table">
                ...
                <tr>
                    ...
                    <td align="center"><img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($field['display']){?>yes<?php  }else{ ?>no<?php }?>.gif" onclick="listTable.toggle(this, 'toggle_dis', <?php echo $field['id'];?>)" /></td>
                    <td align="center"><img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/<?php if($field['is_need']){?>yes<?php  }else{ ?>no<?php }?>.gif" onclick="listTable.toggle(this, 'toggle_need', <?php echo $field['id'];?>)" /></td>
                    <td align="right">
                        <a href="<?php echo U('index');?>&act=edit&id=<?php echo $field['id'];?>">编辑</a>
                        <?php if($field['type'] == 0){?>
                        | <a href="javascript:;" onclick="listTable.remove(<?php echo $field['id'];?>, '确定要删除吗?')" title="移除">移除</a>
                        <?php }?>
                    </td>
                </tr>
