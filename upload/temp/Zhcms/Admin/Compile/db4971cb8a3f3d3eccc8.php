            ...
            <tr>
                <td class="label">
                    <a href="javascript:showNotice('notice_keywords');" title="<?php echo L("admin_ecarticlecat_articlecat_list_page_table_com3");?>">
                        <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/notice.gif" width="16" height="16" border="0" alt="<?php echo L("admin_ecarticlecat_articlecat_list_page_table_com3");?>"/>
                    </a>
