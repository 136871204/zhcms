        ...
        <table align="center" width="400">
            <tr>
                <td width="50" valign="top">
                  <?php if($msg_type == 0){?>
                  <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/information.gif" width="32" height="32" border="0" alt="information" />
                  <?php  }elseif($msg_type == 1){ ?>
                  <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/warning.gif" width="32" height="32" border="0" alt="warning" />
                  <?php  }else{ ?>
                  <img src="http://www.works.com/zh/Zhcms/Admin/Tpl/Public/ec/images/confirm.gif" width="32" height="32" border="0" alt="confirm" />
                  <?php }?>
                </td>
            ...
            <tr>
                ...
                <td id="redirectionMsg">
                  <?php if($auto_redirect){?>如果您不做出选择，将在 <span id="spanSeconds">3</span> 秒后跳转到第一个链接地址。<?php }?>
                </td>
            </tr>
            <tr>
                <td></td>
