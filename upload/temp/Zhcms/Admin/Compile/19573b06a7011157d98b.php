...
PHPSELF = '<?php echo $GLOBALS['user']['PHPSELF'];?>';
    ...
    <link type="text/css" rel="stylesheet" href="http://www.works.com/zh/Zhcms/Admin/Tpl/Login/css/css.css"/>
    <script>
        $(function () {
    ...
    <script type="text/javascript" src="http://www.works.com/zh/Zhcms/Admin/Tpl/Login/Js/js.js"></script>
</head>
<body>
<div class="header">
    <div class="links">
        <a href="http://www.works.com/index.php"><?php echo L("admin_login_top_link");?></a> |
        <a href="http://www.metaphase.co.jp"><?php echo L("admin_login_publisher");?></a> |
        <a href="mailto:136871204@qq.com"><?php echo L("admin_login_chief");?></a>
    </div>
</div>
<div class="main">
    <div class="pics">
