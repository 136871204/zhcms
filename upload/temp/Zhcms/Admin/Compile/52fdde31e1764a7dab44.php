...
PHPSELF = '<?php echo $GLOBALS['user']['PHPSELF'];?>';
    ...
    <script type="text/javascript" src="http://www.works.com/zh/Zhcms/Admin/Tpl/Upload/js/js.js"></script>
    <link type="text/css" rel="stylesheet" href="http://www.works.com/zh/Zhcms/Admin/Tpl/Upload/css/css.css"/>
    <script>
        <?php echo $get;?>
    </script>
</head>
