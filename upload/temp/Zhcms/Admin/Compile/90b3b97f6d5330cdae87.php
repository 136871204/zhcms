...
PHPSELF = '<?php echo $GLOBALS['user']['PHPSELF'];?>';
    ...
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/common.js"></script>
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/jquery.hotkeys.js"></script>
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/msgbox/msgbox.js"></script>
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/extjs/ext-all.js"></script>
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/extjs/locale/ext-lang-zh_CN.js"></script>
    <link type="text/css" href="http://www.works.com/Static/tour/js/msgbox/msgbox.css" rel="stylesheet" />
    <link type="text/css" href="http://www.works.com/Static/tour/css/common.css" rel="stylesheet"/>
    <link type="text/css" href="http://www.works.com/Static/tour/js/extjs/resources/ext-theme-neptune/ext-theme-neptune-all-debug.css" rel="stylesheet"/>
   ...
   <script>
    ...
    <link type="text/css" href="http://www.works.com/Static/tour/css/style.css" rel="stylesheet"/>
    <link type="text/css" href="http://www.works.com/Static/tour/css/base.css" rel="stylesheet"/>
    <link type="text/css" href="http://www.works.com/Static/tour/css/base2.css" rel="stylesheet"/>
    <link type="text/css" href="http://www.works.com/Static/tour/css/plist.css" rel="stylesheet"/>   
    <link type="text/css" href="http://www.works.com/Static/tour/js/extjs/resources/ext-theme-neptune/ext-theme-neptune-all-debug.css" rel="stylesheet"/>   
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/uploadify/jquery.uploadify.min.js?t=2081955"></script>
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/listimageup.js"></script>
    <script type="text/javascript" src="http://www.works.com/Static/tour/js/common.js"></script>   
    <link type="text/css" href="http://www.works.com/Static/tour/js/uploadify/uploadify.css" rel="stylesheet"/>
...
<script>
SITEURL="http://www.works.com/index.php";
